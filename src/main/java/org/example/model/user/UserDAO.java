...
public class UserDAO {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                try {
                    ...
                    boolean is_registered = rs.getBoolean("is_registered");
                    ...
                    System.out.println("Register Status: " + is_registered);
                    System.out.println("Active Status: " + isActive);

                    UserModel user = new UserModel(userId, username, passwordHash, accessLevel, rs.getBoolean("is_registered"), is_registered);
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                UserModel user = new UserModel(
                        ...
                        rs.getBoolean("is_registered"), rs.getBoolean("is_registered")
                );
    ...
    public boolean registerUser(UserModel user) {
        String sql = "UPDATE Users SET username = ?, password_hash = ?, access_level = ?, is_registered = ?, is_active = ? WHERE user_id = ?";
        try (Connection conn = DBConnection.getConnection();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
