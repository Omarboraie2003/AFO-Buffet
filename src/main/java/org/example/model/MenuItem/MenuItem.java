...
public class MenuItem {
    ...
    public void setAvailable(boolean available) { // Fixed the setAvailable method - was setting is_available to itself instead of the parameter
    ...
    public void setType(String item_type) {
        this.item_type = item_type;
    }
